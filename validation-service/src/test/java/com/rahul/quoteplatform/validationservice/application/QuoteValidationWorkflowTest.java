...
class QuoteValidationWorkflowTest {

    @Test
    void shouldSaveProcessedEventAndOutboxEventForValidQuote() {
        ...
        var workflow = new QuoteValidationWorkflow(processedEventRepository, outboxRepository, processor, clock, new ObjectMapper().findAndRegisterModules());
        ...
        assertThat(outboxRepository.events.getFirst().eventType()).isEqualTo("QuoteValidated");
